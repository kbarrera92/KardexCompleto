...
Public Class RptBarcodeGenerator
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptBarcodeGenerator.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Farmacia1._0.RptBarcodeGenerator.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBarcodeGenerator
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBarcodeGenerator = New RptBarcodeGenerator()
        rpt.Site = Me.Site
        Return rpt
    End Function
