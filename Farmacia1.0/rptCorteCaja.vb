...
Public Class rptCorteCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Farmacia1._0.rptCorteCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_eslogan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCorteCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCorteCaja = New rptCorteCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
