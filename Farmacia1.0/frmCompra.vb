...
Public Class frmCompra
        ...
        Else
            ...
            For index = 0 To DataGridView2.Rows.Count - 1
                table.Rows.Add(index + 1, DataGridView2.Rows(index).Cells(0).Value,
                               DataGridView2.Rows(index).Cells(2).Value, DataGridView2.Rows(index).Cells(3).Value, DataGridView2.Rows(index).Cells(4).Value)
            Next
    ...
    Sub GrabaCompra(ByVal table As DataTable)
        Dim cmd As SqlCommand

        Try
            cmd = New SqlCommand()
            With cmd
                .CommandText = "grabaCompra"
            ...
            With cmd.Parameters
                ...
                .AddWithValue("proveedor", CInt(cmbProveedor.SelectedValue.ToString()))
